# #!/usr/bin/env python3
# """
# App Server - FastAPI Backend for PySR System (Fixed)
# Handles user management, job management, and database operations
# """
...
#             RETURNING id
#         """, user_data.username, user_data.email, 
#             get_password_hash(user_data.password), user_data.full_name)
...
#         jobs = [Job(**dict(record)) for record in job_records]
...
#             if data:
#                 response = await client.post(f"{MCP_SERVER_URL}/tools/{endpoint}", json=data)
#             else:
...
#     # This will work correctly with the reload flag
#     uvicorn.run(
#         "app_server:app",  # Use import string instead of app object
#         host="0.0.0.0",
#         port=8000,
#         reload=True,
#         log_level="info"
